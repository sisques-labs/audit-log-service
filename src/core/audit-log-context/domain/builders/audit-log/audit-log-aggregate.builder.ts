...
import { IAuditLog } from '@/core/audit-log-context/domain/dtos/entities/audit-log.dto';
import { AuditLogPrimitives } from '@/core/audit-log-context/domain/primitives/audit-log.primitives';
...
export class AuditLogAggregateBuilder {
  ...
  public withAggregateRootType(aggregateRootType: AuditLogAggregateRootType): this {
  ...
  public fromPrimitives(primitives: AuditLogPrimitives): this {
    ...
    this._aggregateRootId = new AuditLogAggregateRootId(primitives.aggregateRootId);
    this._aggregateRootType = new AuditLogAggregateRootType(primitives.aggregateRootType);
