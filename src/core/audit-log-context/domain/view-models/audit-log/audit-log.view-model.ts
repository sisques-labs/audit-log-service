import { IAuditLogViewModelDto } from '@/core/audit-log-context/domain/dtos/view-models/audit-log-view-model.dto';
...
export class AuditLogViewModel extends BaseViewModel {
  ...
  public static fromPrimitives(primitives: AuditLogPrimitives): AuditLogViewModel {
